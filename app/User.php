    ...
    \JsonSerializable
{
    ...
    use Authenticatable, Authorizable, CanResetPassword, HasApiTokens, Notifiable, LogGlobalTrait;
    ...
    {
    	return $this->hasMany('App\Promoter', 'user_id');
    }
...
/*############## получение аватара заданного юзера #######################################*/
	...
	public function jsonSerialize() {
		...
		$res = array(
            ...
            'full_name' => $this->name_family.' '.$this->name.' '.$this->name_patronymic,
            'gender' => $this->gender,
		...
		if ($this->role_id == 101) {
			...
			$orderers_count = Orderer::whereIn('customer_id', $customers)->get()->count();
