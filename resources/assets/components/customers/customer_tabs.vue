...
<script>
    ...
    import customer_treatment from './customer_treatment';
    import customer_orderers from './customer_orderers';
    ...
    export default {
      ...
      components: { change_history, customer_orderers, customer_treatment, customer_calendar },
      computed: {
