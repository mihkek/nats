            ...
            <template v-slot:item="{ item }">
              <tr class="table-row">
                <td class="px-2 text-center">
                  <span class="caption">{{item.opc_code}}</span>
                </td>
                <td class="px-2">
                ...
                <td class="px-2">
                  <span class="caption">{{item.working_count}}</span>
                </td>
              </tr>
            </template>
          </v-data-table> 
...
export default {
  ...
  data () {
    return {
      ...
      subdivision: {},
      headers: [
        { id: 1, text: '№ OPC', value: 'opc_code', width: 90, class: 'px-2', align: 'center' },
        { id: 2, text: 'Анкет', value: 'requesters_count', width: 90, class: 'px-2'  },
        { id: 3, text: 'Пришедших', value: 'deal_count', width: 110, class: 'px-2' },
        { id: 4, text: 'Оплаты', value: 'pays_amount', width: 100, class: 'px-2' },
        { id: 5, text: 'Сделок', value: 'pay_deal_count', width: 110, class: 'px-2' },
        { id: 6, text: 'Ложных', value: 'false_count', width: 90, class: 'px-2' },
        { id: 7, text: '% ложных', value: 'false_percent', width: 100, class: 'px-2'  },
        { id: 8, text: 'Отказов', value: 'cancel_count', width: 110, class: 'px-2' },
        { id: 9, text: '% отказов', value: 'cancel_percent', width: 110, class: 'px-2' },
        { id: 10, text: '% пришедших', value: 'deal_percent', width: 120, class: 'px-2' },
        { id: 11, text: '% сделок', value: 'pay_deal_percent', width: 110, class: 'px-2' },
        { id: 12, text: 'Общая сумма', value: 'total_amount', width: 120, class: 'px-2' },
        { id: 13, text: 'В работе', value: 'working_count', width: 110, class: 'px-2' },
      ],
    }
  },
  props: {
  ...
  methods: {
    ...
    getItems() {
      ...
      this.$store.dispatch('GET_PROMOTERS_REPORT', params).then(res => {
      })
