<template>
  <v-hover v-slot="{ hover }">
    <v-card :elevation="hover ? 6 : 2"  :href="'/tenders/'+item.auction.id+'-'+item.auction.slug" target="_blank">
