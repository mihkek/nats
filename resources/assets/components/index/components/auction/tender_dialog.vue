    ...
    <v-card-text style="max-height: 75vh;" class="py-0 px-2">
      <v-container fluid grid-list-md class="py-0">
        ...
        <v-layout row wrap>
          ...
          <v-flex md12 v-if="item.auction.delivery_condition == 2 || item.auction.delivery_condition == 3">
            <v-list-item class="px-2">
              <v-list-item-content>
        ...
        <v-layout row wrap>
          ...
          <v-flex md8>
            <v-card-actions class="pt-6">
              <v-spacer></v-spacer>
              <v-btn color="success" large :href="'/admin/tender/now/card/'+item.auction.id">Предложить цену</v-btn>
