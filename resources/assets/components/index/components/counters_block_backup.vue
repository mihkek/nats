    ...
    <div class="container container--fluid" style="padding: 1.5em 36px; margin: 0px; background: rgba(0, 0, 0, 0.3);">
                    <div class="layout row wrap" style="margin: 0px; max-width: 960px;">
                        <div class="flex sm3 xs12">
                            <h5 class="counter" style="margin: 0.25em 0px 0px; line-height: 150%; text-transform: uppercase; padding: 0.5em 0px; opacity: 1;"><b style="font-size: 250%;">2&nbsp;113</b><br>пользователей</h5>
                        </div>
                        <div class="flex sm3 xs12">
                            <h5 class="counter" style="margin: 0.25em 0px 0px; line-height: 150%; text-transform: uppercase; padding: 0.5em 0px; opacity: 1;"><b style="font-size: 250%;">3&nbsp;435</b><br>Тендеров</h5>
                        </div>
                        <div class="flex sm6 xs12">
                            <h5 class="counter" style="margin: 0.25em 0px 0px; line-height: 150%; text-transform: uppercase; padding: 0.5em 0px; opacity: 1;"><b style="font-size: 250%;">524&nbsp;941&nbsp;430</b><b style="font-size: 150%;">&nbsp;₽</b><br>Общая стоимость тендеров<br></h5>
                        </div>
                    </div>
                </div>
-->
