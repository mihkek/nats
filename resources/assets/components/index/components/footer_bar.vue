<template style="border-top: 5px solid #F1F1F1;">
  <v-footer
    dark
    app
    color="#5D6160"
  ...
  >
    ...
    >
      ...
      <div class="page-footer" style="padding: 40px 20px;">
        <div class="page-footer-inner">
          <div class="row">
            <div class="col-sm-8">
              <div style="margin-bottom: 10px;">
                <a v-if="user_id>0" href="/admin"><img src="/img/logo/footer-logo.png" alt="" style="height: 45px;"></a>
                <a v-else href="/"><img src="/img/logo/footer-logo.png" alt="" style="height: 45px;"></a>
              </div>
              <small>
                ООО "НАТС" •
      ...
      <div class="page-footer" style="padding: 12px 20px;">
        <div class="page-footer-inner">
          <div class="row">
            <div class="col-sm-12 text-center">
              <small>
                &copy; 2020-2022 • ООО "НАТС"  ИНН 7719723080
              </small>
            </div>
          </div>
        </div>
