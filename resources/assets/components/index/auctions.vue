        ...
        <v-layout row wrap>
          <v-flex xs12>
            ...
            <v-card color="transparent" flat class="my-3">
                <v-card-title>
                    <h1 class="my-0 display-1">Все аукционы</h1>
                </v-card-title>
                <v-card-subtitle class="pb-0">
                    <a href="/admin/auction/add" class="px-1 success--text">Разместить аукцион</a>
                </v-card-subtitle>
            </v-card>
...
import auction_card from './components/auction/auction_card'
import auction_dialog from './components/auction/auction_dialog'
