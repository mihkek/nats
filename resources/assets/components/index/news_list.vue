              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="section-title">
                    <h2>Актуальное в АПК</h2>
                  </div>
                </div>

                <div class="col-md-3" v-for="ns in news">
                  <div class="post">
                    <a class="post-img" :href="'/news/'+ns.slug"><img
                        :src="ns.image!='underfined'&&ns.image.length>=1?ns.image:'/img/no-image.jpg'" :title="ns.title" :alt="ns.title"></a>
                    <div class="post-body">
                      <div class="post-meta">
                        <span class="post-date">{{ ns.created_formated }}</span>
                      </div>
                      <h3 class="post-title"><a :href="'/news/'+ns.slug">{{ ns.title }}</a></h3>
                    </div>
                  </div>
                </div>
