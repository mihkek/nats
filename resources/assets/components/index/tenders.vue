        ...
        <v-layout row wrap>
          <v-flex xs12>
            ...
            <v-card color="transparent" flat class="my-3">
                <v-card-title>
                    <h1 class="my-0 display-1">Все тендеры</h1>
                </v-card-title>
                <v-card-subtitle class="pb-0">
                    <a href="/admin/tender/add" class="px-1 success--text">Разместить тендер</a>
                </v-card-subtitle>
            </v-card>
...
import tender_card from './components/auction/tender_card'
import tender_dialog from './components/auction/tender_dialog'
