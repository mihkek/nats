...
<!--{{--
            <div class="row">
				...
				<p style="margin-top:0px;">Раздел помощи касается управления пользователями, их правами, и настройками. Содержит особенности его использования, ответы на часто задаваемые вопросы, и прочую полезную информацию.</p>
                </div>
            </div>
--}}-->
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6">
				<div class="mt-element-ribbon bg-grey-steel">
					<div class="ribbon ribbon-left ribbon-shadow ribbon-color-danger uppercase">Подключение к API</div>
					<div class="ribbon-content">
						<?PHP $filename = '/storage/help/' . 'Documentation_API_Admin.docx'; ?>
