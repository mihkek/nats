...
@php
$price = 5000; // начальный прайс данной услуги
@endphp
		...
		<div class="col-xs-12">
			<div class="portlet light">
				<div class="portlet-body text-center">
					...
					Пакет кобрэндинговых карт со стандартным дизайном<br />
					<div class="text-center" style="font-size: 38px; font-weight: 700;">
						...
						<select name="total" id="myTotal">
							<option value="100" data-price="5000">100</option>
							<option value="200" data-price="10000">200</option>
							<option value="300" data-price="15000">300</option>
							<option value="500" data-price="25000">500</option>
						</select> КАРТ
						</span></span>
					</div>
