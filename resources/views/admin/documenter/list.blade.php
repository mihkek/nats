...
<div class="row">
	<div class="col-xs-12">
                                <div class="category-list">
                                    ...
                                    <a href=@if ($category->id > 0) "/admin/documenter/list/{{ $category->id }}" @else "/admin/documenter/list" @endif class="btn {{ $category->id == $categoryId ? 'white font-dark' : 'btn-success' }}">{{ $category->name }}</a> 
                                    @endforeach
								</div>
	</div>
</div>
...
--}}-->
					<td class="text-center">
						<a href="/admin/documenter/list/card/{{ $document->id }}" class="btn btn-sm btn-success">
