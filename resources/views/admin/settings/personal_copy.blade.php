...
--}}
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-user font-blue-soft"></i>
                                <span class="caption-subject font-blue-soft uppercase">Детали работы преподавателя</span>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="#" id="formUpdateLogoped" class="form-horizontal" name="formUpdateLogoped" method="post">
                                {{ csrf_field() }}

                                <div class="form-group">
                                    <label class="col-md-5 control-label">Станция метро</label>
                                    <div class="col-md-7">
                                        <select class="form-control" name="test"/>
                                        <option value=""></option>
                                        <option value="">Тут будет список станций</option>
                                        <option value="">Тут будет список станций</option>
                                        <option value="">Тут будет список станций</option>
                                        <option value="">Тут будет список станций</option>
                                        <option value="">Тут будет список станций</option>
                                ...
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Диагнозы</label>
                                    <div class="col-md-7">
                                        <select class="form-control" name="test"/>
                                        <option value=""></option>
                                        <option value="">Логоневроз</option>
                                        <option value="">Лалоневроз</option>
                                        <option value="">Логоклония</option>
                                        <option value="">Баттаризм</option>
                                        <option value="">Бальбуцио</option>
                                        </select>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-5 control-label">Возрастная группа</label>
                                    <div class="col-md-7">
                                        <select class="form-control" name="test"/>
                                        <option value=""></option>
                                        <option value="">7-12 лет</option>
                                        <option value="">13-17 лет</option>
                                        <option value="">17-21 год</option>
                                        <option value="">21-40 лет</option>
                                        <option value="">41 и более лет</option>
                                        </select>
                                    </div>
                                </div>
