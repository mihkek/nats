...
<!--{{--
            <div class="row">
				...
				<p style="margin-top:0px;">Раздел помощи касается сервиса "Шаблоны", и содержит особенности его использования, ответы на часто задаваемые вопросы, и прочую полезную информацию.</p>
                </div>
            </div>
--}}-->
