...
<div class="alert alert-info text-center" style="margin-top:20px;">
            ...
            Пожалуйста, дождитесь сообщения с результатами проверки, обычно обработка данных занимает один рабочий день.<br><br>
        </div>

      <div style="width: 250px; margin: 0 auto;">
        <a href="/login"><button class="btn blue uppercase" style="width:100%; height:43px;">Вход в личный кабинет</button></a>
      </div>
